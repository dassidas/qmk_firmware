...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F9,   KC_F10,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, MOUSE,
...
[_MOUSE] = LAYOUT_planck_grid(
    KC_TAB,   KC_MS_BTN1, KC_MS_U,    KC_MS_BTN2, _______,       _______,    _______,       KC_MS_BTN1,  KC_MS_U,   KC_MS_BTN2, _______,   _______,
    KC_ACL2,   KC_MS_L,    KC_MS_D,    KC_MS_R,    KC_MS_BTN5,    _______,    KC_MS_BTN5,    KC_MS_L,     KC_MS_D,   KC_MS_R,    _______,   _______,
    KC_LSFT,  KC_WH_D,    _______,    KC_WH_U,    KC_MS_BTN4,    _______,    KC_MS_BTN4,    KC_WH_D,     _______,   KC_WH_U,    KC_ACL2,   _______ ,
    QWERTY,   KC_LCTL,    KC_LALT,    KC_LGUI,    KC_MS_BTN1,    KC_MS_BTN2, KC_MS_BTN2,    KC_MS_BTN1,  KC_WH_L,   KC_WH_D,    KC_WH_U,   KC_WH_R
)
